			...
			<div className="container">
				...
				{[9].map((item) => (
					<Accordion key={item}>
						...
						<p className="accordion-body">
						First of all, as we said it’s a real & organic music promotion service. Which complies with Youtube terms & conditions. Beside that we guarantee the privacy of your personal data as well your Youtube artist's account is completely protected from any risks.
						</p>
					</Accordion>
